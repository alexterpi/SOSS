...
`SOSS` can be downloaded from its GitHub repository::
...
You are free to use, modify, and redistribute this software under the terms of the GPLv3. See the `LICENSE` file for the full license text.
